...
import server.lib.orm.logger.LoggerFactory.LogFactory;
...
public class LocalLog implements Log {
	...
	public static final String LOCAL_LOG_LEVEL_PROPERTY = "server.lib.orm.logger.level";
	public static final String LOCAL_LOG_FILE_PROPERTY = "server.lib.orm.logger.file";
