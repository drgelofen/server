...
import server.lib.orm.misc.VersionUtils;
...
import server.lib.orm.support.GeneratedKeyHolder;
...
public class JdbcDatabaseConnection implements DatabaseConnection {
	...
	private static final String JDBC_VERSION = "VERSION__5.4-SNAPSHOT__";
